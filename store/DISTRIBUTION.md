...
- Current upload artifact: `dist/store/PromptDirector-1.22.4-Chrome-Web-Store.zip`. Keep this artifact local for Web Store submission. The sole GitHub extension installation package is `PromptDirector-1.22.2.zip`, with stable identity and the local updater.
