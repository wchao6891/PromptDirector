...
export function renderSharePreviewHtml(
  ...
  const installAction = installUrl
    ? `<a class="button-secondary install-action" href="${escapeAttribute(installUrl)}" target="_blank" rel="noreferrer"><span data-zh="获取 PromptDirector" data-en="Get PromptDirector">${locale === "en" ? "Get PromptDirector" : "获取 PromptDirector"}</span></a>`
    : "";
