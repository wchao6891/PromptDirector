...
function normalizeSourceContext(value = {}) {
  ...
  return {
    ...
    sourceFacts: {
      ...
      authorUrl: safeHttpUrl(sourceFactsValue.authorUrl),
      originalSourceUrl: safeHttpUrl(sourceFactsValue.originalSourceUrl),
      imageDescription: clean(sourceFactsValue.imageDescription),
      metadataError: clean(sourceFactsValue.metadataError),
      engagementObservedAt: validIso(sourceFactsValue.engagementObservedAt),
