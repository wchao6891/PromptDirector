...
下载并解压本仓库源码，在 Chrome 或 Edge 的扩展管理页开启“开发者模式”，选择“加载已解压的扩展程序”，然后选择仓库根目录。

升级前请先在“更多 → 备份与同步”创建并验证完整资料夹备份。若扩展身份发生变化，请按[扩展身份迁移说明](docs/EXTENSION_ID_MIGRATION.md)恢复资料。
