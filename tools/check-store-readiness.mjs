...
const submission = await text("store/DISTRIBUTION.md");
requireText(submission, `dist/store/PromptDirector-${manifest.version}-Chrome-Web-Store.zip`, "商店提交清单版本与 manifest 不一致");
